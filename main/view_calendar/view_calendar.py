...
def display_events(service,role):

    now = datetime.datetime.utcnow().isoformat() + 'Z' # 'Z' indicates UTC time
    first_date = datefinder.finddates(now)
...
#    start import datefinder= datetime.datetime(d.year, d.month, d.day, int(start[0]),int(start[1]))
