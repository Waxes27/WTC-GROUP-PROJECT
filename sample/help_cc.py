...
list_of_commands = ["USERNAME","HELP","MAKEBOOK","LOGOUT",]
details_of_commands = ["Enter in your username","Shows information about the available commands", "Makes a booking for a code cliinic session","Logs the user out"]
